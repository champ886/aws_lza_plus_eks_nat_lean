...
terraform apply -auto-approve \
  ...
  -var="workload_account_id=435321828725" \
  -var="git_repo_url=https://github.com/champ886/aws_lza_plus_eks_nat_lean.git" \
...
terraform apply -auto-approve -var="workload_account_id=435321828725" ...
```
